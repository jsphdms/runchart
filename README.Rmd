...
Run charts are one of the fundamental tools of quality improvement. runchart is designed to make it quick and easy to create run charts. Learn more in `vignette("quick-start")` or `?runchart`.
