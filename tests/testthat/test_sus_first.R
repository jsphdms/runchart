...
test_that("sus_first() handles corner cases", {
  ...
  expect_equal(sus_first(base = 0, val = c(rep(0, 9), rep(1, 8), rep(0, 9))),
               NULL)
  expect_equal(sus_first(base = 0, val = c(rep(0, 9), rep(1, 8), rep(0, 8), 1)),
               c(10:17, 26))
  ...
  expect_equal(sus_first(base = 0, val = rep(c(1, 1, 0, 0), 5)),
               c(1, 2, 5, 6, 9, 10, 13, 14, 17))
  ...
  expect_equal(sus_first(base = 0, val = c(1, rep(NA, 3), rep(1, 16))),
               c(1, 5:12))
  ...
  # Missing after 8
  expect_equal(sus_first(base = 0, val = c(rep(0, 10), rep(NA, 5), rep(0, 5))),
               NULL)
